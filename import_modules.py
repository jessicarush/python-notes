...
print(ran.choice(possibilities))

# Notice when we import a whole module, you have to use the module name. as
# prefix to any functions you want to use from that module. This is to avoid
# any possible naming conflicts between modules. In the next example we import
# a function directly and rename it.
