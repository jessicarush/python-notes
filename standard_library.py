...
# The example above is just an example. If you wanted to actually check for paildromes you could also do:
...
# each returns one item at a time when called within a for... in loop and rememebers its state between calls
...
# this will be used instead of addition. The function should take two arguments and return a single result.
