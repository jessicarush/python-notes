...
# ***Coming: use Redis lists and publish-subscribe to implement job queues***
...
# Each date is a separate key. Set the bit for a user ID for that date. For
# example, on the first date two users logged in:
