...
"""
Functions are objects, just like numbers, strimgs, tuples, lists, dictionaries,
etc. They can be assigned to variables, used as arguments to otehr functions,
...
knows the value of saying that was passed in and remembers it. The line return
inner2 returns this specialized copy of the inner2 function (but doesn't call it).
